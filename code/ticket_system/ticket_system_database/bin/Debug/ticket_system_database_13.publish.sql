...
GO
/*
The table [dbo].[group_member] is being dropped and re-created since all non-computed columns within the table have been redefined.
*/

IF EXISTS (select top 1 1 from [dbo].[group_member])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
/*
The table [dbo].[project_group] is being dropped and re-created since all non-computed columns within the table have been redefined.
*/

IF EXISTS (select top 1 1 from [dbo].[project_group])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_group_member_Employees_EmployeesEId]...';


GO
ALTER TABLE [dbo].[group_member] DROP CONSTRAINT [FK_group_member_Employees_EmployeesEId];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_group_member_Groups_GroupsExistingInGId]...';


GO
ALTER TABLE [dbo].[group_member] DROP CONSTRAINT [FK_group_member_Groups_GroupsExistingInGId];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_project_group_Groups_AssignedGroupsGId]...';


GO
ALTER TABLE [dbo].[project_group] DROP CONSTRAINT [FK_project_group_Groups_AssignedGroupsGId];


GO
PRINT N'Dropping Foreign Key [dbo].[FK_project_group_Projects_AssignedProjectsPId]...';


GO
ALTER TABLE [dbo].[project_group] DROP CONSTRAINT [FK_project_group_Projects_AssignedProjectsPId];


GO
PRINT N'Dropping Index [dbo].[group_member].[IX_group_member_GroupsExistingInGId]...';


GO
DROP INDEX [IX_group_member_GroupsExistingInGId]
    ON [dbo].[group_member];


GO
PRINT N'Dropping Table [dbo].[group_member]...';
...
GO
PRINT N'Dropping Index [dbo].[project_group].[IX_project_group_AssignedProjectsPId]...';


GO
DROP INDEX [IX_project_group_AssignedProjectsPId]
    ON [dbo].[project_group];


GO
PRINT N'Dropping Table [dbo].[project_group]...';
